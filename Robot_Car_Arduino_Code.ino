...
int servo_cam_angle_int_y = 0; // The past value of the variable that the servo had before the new loop
...
void setup() {
  ...
  servo_cam.attach(servo_cam_pin);       // Attach the servo to the pin GPIO 4, the same as D2 for the ESP8266 module
  servo_steer.attach(servo_steer_pin);   // Attach the servo to the pin GPIO 5, the same as D1 for the ESP8266 module
